...
import com.example.lolchampions.data.repository.ApiRespositoryImpl
...
object AppModule {
    ...
    fun privideHttpClient(): HttpClient =
        HttpClient(OkHttp.create()) {
            defaultRequest { url(ApiRespositoryImpl.baseUrl)
    ...
    fun provideApiRepository(httpClient: HttpClient): ApiRepository =
        ApiRespositoryImpl(httpClient = httpClient)
